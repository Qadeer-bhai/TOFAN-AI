 ...
 * @author : Qadeer Kham <https://github.com/Qadeer-bhai>
...
const ownerNumber = ['923079749129']

//===================SESSION-AUTH============================
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
if(!config.SESSION_ID) return console.log('Please add your session to SESSION_ID env !!')
const sessdata = config.SESSION_ID.replace("TOFAN-AI~", '');
...
console.log("CONNECTING TOFAN-AI 🧬...");
...
console.log('TOFAN-AI CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ TOFAN-AI ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ your name ✅*
...
//================ownerreact==============
if(senderNumber.includes("92377777777")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("923777777777")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("923079749129")){
if(isReact) return
m.react("🦋")
   }
